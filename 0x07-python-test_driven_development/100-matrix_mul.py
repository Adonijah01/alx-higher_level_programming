...
def matrix_mul(m_a, m_b):
    ...
    # variables to verify whether  both m_a and m_b can be multiplied
    num_colum1 = 0
    num_row2 = 0

    # Check requiremnts for matrix m_a
    if m_a == []:
    ...
    # Check requiremnts for matrix m_b
    if m_b == []:
    ...
    # Check whether multiplication is posible
